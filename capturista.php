...
$fireiphp = FirePHP::getInstalnstane(TRUE);
$fireiphp ->log('Php esta funcionando', 'info');
...
//		$userCapturista = isset($_POST['userCapturista']) ? $_POST['userCapturista'] : null ;
//		$passCapturista = isset($_POST['passCapturista']) ? $_POST['passCapturista'] : null ;
//		$correoCapturista = isset($_POST['correoCapturista']) ? $_POST['correoCapturista'] : null ;

//			$userCapturista = pg_escape_string($_POST['userCapturista']) ;
//			$passCapturista = pg_escape_string($_POST['passCapturista']);
//			$correoCapturista = pg_escape_string($_POST['correoCapturista']);
...
//			$mensajesAll = "El registro a sido creado.";
//			if ( $mensajesAll != "" ) 
//			{
